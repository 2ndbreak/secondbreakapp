...
const events: Event[] = [
  ...
  },
  {
    ...
    title: "2ND BREAK ACTIVATION DAY — BRING YOUR GAME AND YOUR FRIENDS",
    date: "13 JULY 2026",
    location: "19 AMESHOF STREET , BRAMFONTEIN",
    city: "JOHANNESBURG",
    status: "past",
    summary: "One location. Two hours. One big room. Folktales in different languages and Games, recorded for the archive.",
  },
  {
    slug: "school-visit-limpopo",
    title: "PRASA TRAIN VISIT\u00a0",
    date: "10 JULY 2026",
    location: "2ND BREAK TEAM DOCUMENTING\u00a0\u00a0",
    city: "JOHANNESBURG TRAINSTATION",
    status: "past",
    summary: "Team interviewed community inside train about the games they used to play inside , many years ago. Selected entries will feature in next year's edition of the book.",
  },
];
